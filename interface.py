...
en_button = Button(paned, text="Démarrer l'enregistrement", font=("courrier",15),bg='white',fg='black',command=start_recording)
ar_button = Button(paned, text="Arrêter l'enregistrement", font=("courrier",15),bg='white',fg='black',command=stop_recording)
sv_button = Button(paned, text="Sauvegarder le fichier", font=("courrier",15),bg='white',fg='black',command=save_file)
