...
# l 'ajout d'un texte
label_message = Label(window,text="Welcome!", font = ('courrier',20),bg='#bfbecb')
label_message.pack(padx=15, pady=10)

#la zone de texte
text=Text(window,height=23,width=500)
...
#Butons texte
txt_button =Button(paned1,text="Send question",font=("courrier",15),bg='white',fg='black',command=chat)
ef_button =Button(paned1,text='New question',font=("courrier",15),bg='white',fg='black',command=stop_chat)
qt_button =Button(paned1,text='Delete',font=("courrier",15),bg='white',fg='black',command=stop_chat)
...
en_button = Button(paned, text="Start Recording", font=("courrier",10),bg='white',fg='black',command=start_recording)
ar_button = Button(paned, text="Stop Recording", font=("courrier",10),bg='white',fg='black',command=stop_recording)
sv_button = Button(paned, text="new Recording", font=("courrier",10),bg='white',fg='black',command=new_recording)
